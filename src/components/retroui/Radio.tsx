...
const radioVariants = cva(
  "border-black border-2 flex items-center justify-center shrink-0",
  {
    variants: {
      variant: {
        default: "",
      ...
      size: {
        ...
        lg: "h-6 w-6 min-w-[24px] min-h-[24px]",
      },
    },
    defaultVariants: {
      variant: "default",
...
export const RadioItem = ({
  ...
  >
    <RadioPrimitive.Indicator className="flex items-center justify-center w-full h-full">
