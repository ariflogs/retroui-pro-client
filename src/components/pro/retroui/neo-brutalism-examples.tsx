...
const websites = [
    {
        ...
        url: "feastables.com",
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/feastables.png"
    },
    {
        name: "Gumroad",
        category: "Payment",
        ...
        url: "gumroad.com",
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/gumroad.png"
    },
    {
        name: "YouTube Rewind",
        category: "Media",
        ...
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/youtube_rewind.png"
    },
    {
        name: "RozeBunker",
        category: "E-commerce",
        ...
        url: "rozebunker.nl",
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/rozebunker.png"
    },
    {
        name: "Kristi Digital",
        category: "Portfolio",
        ...
        url: "kristi.digital",
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/kristi_digital.png"
    },
    {
        name: "GT Maru",
        category: "Design",
        ...
        url: "gt-maru.com",
        image: "https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/examples/gt_maru.png"
    }
];

export default function NeoBrutalistExamples() {
    ...
    return (
        <div className="mx-auto py-24">
                        ...
                        <div className="h-52 border-b-2 border-black relative overflow-hidden bg-muted">
                            ...
                            <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-1">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="bg-white rounded text-black border-white hover:bg-white/90"
            ...
            <div className="text-center">
                ...
                <a href="/blocks" className="inline-block mx-auto">
