...
export default function RetroUITestimonials() {
    return (
        <div className="max-w-6xl mx-auto max-lg:px-4 py-24">
            {/* Header Section */}
            <div className="mb-12">
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                {testimonials.map((testimonial, index) => (
                    ...
                    >
                        <img src="https://pub-5f7cbdfd9ffa4c838e386788f395f0c4.r2.dev/icons/quote.svg" alt="quote" className="w-12 h-12 mb-2" />
